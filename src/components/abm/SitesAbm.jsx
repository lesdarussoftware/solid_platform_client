...
import { FortnightDetails } from "../sites/FortnightDetails";
import { SeveralFortnights } from "../sites/SeveralFortnights";
                    ...
                    {open === 'FORTNIGHTS' ?
                        ...
                        open === 'RULES' ?
                            <FortnightDetails
                                ...
                                setOpenSite={setOpen}
                                setWorkOnFortnight={setWorkOnFortnight}
                                workOnFortnight={workOnFortnight}
                            /> :
                            <>
                                <SeveralFortnights
                                    open={open}
                                    ...
                                    contentHeader={
                                        <Box sx={{ display: 'flex', justifyContent: 'space-between', marginTop: { xs: 5, sm: 2 } }}>
                                            ...
                                            <Box sx={{ display: 'flex', gap: 1 }}>
                                                <Button type="button" variant="contained" onClick={() => setOpen('NEW-FORTNIGHTS')}>
                                                    Conf. gral.
                                                </Button>
